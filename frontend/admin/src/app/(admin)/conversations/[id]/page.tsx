        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-[#D1FAE5] text-[#065F46]">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                Positive Sentiment
              </span>
              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-[#F8FAFC] border border-[#E2E8F0] text-[10px] font-medium text-[#475569]">
            ...
            <div className="flex flex-wrap items-center gap-y-1 gap-x-3.5 text-xs text-[#475569] mt-1.5">
              ...
              <span>Duration: <strong>2m 45s (6 turns)</strong></span>
          ...
          <div className="flex items-center gap-1.5">
            <Link
              ...
              className="px-2.5 py-1.5 bg-[#EFF6FF] border border-[#BFDBFE] hover:bg-blue-100 text-[#2563EB] rounded-md text-xs font-semibold transition-colors flex items-center gap-1.5 shadow-2xs"
            >
        ...
        <div className="lg:col-span-7 space-y-3.5">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-lg p-3.5 shadow-2xs space-y-2.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-[#475569] font-medium">Twilio Media Stream (Opus 48kHz)</span>
            </div>

            <div className="p-2 sm:p-2.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-md flex items-center gap-2.5">
              <button
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-lg p-3.5 shadow-2xs space-y-2.5">
            <div className="flex items-center justify-between pb-2 border-b border-[#E2E8F0]">
              ...
              <span className="text-[10px] text-[#94A3B8]">Deepgram STT ➔ Groq LLM ➔ ElevenLabs TTS</span>
            </div>

            <div className="space-y-2.5 pt-1">
              {/* Turn 1 */}
              <div className="flex gap-2.5">
                <div className="w-6 h-6 rounded-full bg-blue-500 text-white flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                  AI
                </div>
                <div className="flex-1 p-2.5 rounded-lg bg-[#EFF6FF] border border-[#BFDBFE]/70 text-xs leading-relaxed">
                  <div className="flex justify-between items-center mb-0.5">
                    <span className="font-bold text-[#2563EB]">Sarah (AI Receptionist)</span>
                    <span className="text-[10px] text-[#94A3B8]">10:24:02 AM · 210ms</span>
                  </div>
              ...
              {/* Turn 2 */}
              <div className="flex gap-2.5">
                <div className="w-6 h-6 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                  U
                </div>
                <div className="flex-1 p-2.5 rounded-lg bg-gray-50 border border-[#E2E8F0] text-xs leading-relaxed">
                  <div className="flex justify-between items-center mb-0.5">
              ...
              <div className="ml-8 p-2 rounded-md bg-emerald-50 border border-emerald-200 text-[10px] text-emerald-800 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-emerald-700">
                    <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>
                  </svg>
                  <span><strong>Tool:</strong> <code>{'check_doctor_availability(date="2026-02-03", service="teeth_cleaning")'}</code></span>
                </div>
                <span className="font-semibold text-emerald-700">2 slots (80ms)</span>
              </div>
              ...
              <div className="flex gap-2.5">
                ...
                <div className="flex-1 p-2.5 rounded-lg bg-[#EFF6FF] border border-[#BFDBFE]/70 text-xs leading-relaxed">
                  <div className="flex justify-between items-center mb-0.5">
                    <span className="font-bold text-[#2563EB]">Sarah (AI Receptionist)</span>
                    <span className="text-[10px] text-[#94A3B8]">10:24:14 AM · 240ms</span>
                  </div>
              ...
              <div className="ml-8 p-2 rounded-md bg-emerald-50 border border-emerald-200 text-[10px] text-emerald-800 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span><strong>Tool:</strong> <code>{'create_appointment(slot="10:00", patient="Sarah Wilson")'}</code></span>
                </div>
                <span className="font-semibold text-emerald-700">APT-8921 (110ms)</span>
              </div>
              ...
              <div className="flex gap-2.5">
                ...
                <div className="flex-1 p-2.5 rounded-lg bg-[#EFF6FF] border border-[#BFDBFE]/70 text-xs leading-relaxed">
                  <div className="flex justify-between items-center mb-0.5">
                    <span className="font-bold text-[#2563EB]">Sarah (AI Receptionist)</span>
                    <span className="text-[10px] text-[#94A3B8]">10:24:26 AM · 220ms</span>
                  </div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-lg p-3.5 shadow-2xs space-y-2">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="p-2 bg-[#F8FAFC] border border-[#E2E8F0] rounded-md">
                <div className="font-semibold text-[#0F172A] text-xs">Smile_Dental_Services_and_Pricing.pdf</div>
                <div className="text-[10px] text-[#94A3B8]">Similarity Score: 0.94 · Chunk #14</div>
              </div>
              <div className="p-2 bg-[#F8FAFC] border border-[#E2E8F0] rounded-md">
                <div className="font-semibold text-[#0F172A] text-xs">Practitioner_Doctor_Hours_2026.docx</div>
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-lg p-3.5 shadow-2xs space-y-2">
            ...
            <div className="space-y-1.5 text-xs">
              ...
              <div className="flex justify-between py-1 border-b border-[#E2E8F0]">
                ...
                <span className="text-[#0F172A] font-medium">Amsterdam, NL</span>
              </div>
              <div className="flex justify-between py-1">
            ...
            <div className="pt-1.5 flex gap-2">
              <Link
                href="/receptionists"
                className="w-full py-1.5 text-center bg-[#F8FAFC] hover:bg-gray-100 border border-[#E2E8F0] rounded-md text-xs font-semibold text-[#0F172A] transition-colors shadow-2xs"
              >
