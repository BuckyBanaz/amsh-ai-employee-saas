    ...
    <div className="bg-white border border-gray-100 rounded-xl shadow-[0_1px_4px_rgba(0,0,0,0.03)] flex flex-col flex-1 overflow-hidden">
      ...
      <div className="overflow-x-auto scrollbar-hide flex-1">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              <th className="px-3.5 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-[#F9FAFB]/60">{STRINGS.TABLES.KNOWLEDGE.HEADERS.NAME}</th>
              <th className="px-3.5 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-[#F9FAFB]/60">{STRINGS.TABLES.KNOWLEDGE.HEADERS.TYPE}</th>
              <th className="px-3.5 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-[#F9FAFB]/60">{STRINGS.TABLES.KNOWLEDGE.HEADERS.STATUS}</th>
              <th className="px-3.5 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-[#F9FAFB]/60">{STRINGS.TABLES.KNOWLEDGE.HEADERS.LAST_UPDATED}</th>
              <th className="px-3.5 py-2.5 text-[10px] font-bold text-gray-400 uppercase tracking-wider border-b border-gray-100 bg-[#F9FAFB]/60 text-right">{STRINGS.TABLES.KNOWLEDGE.HEADERS.ACTIONS}</th>
            </tr>
          </thead>
              ...
              <tr key={idx} className="hover:bg-gray-50/50 transition-colors group">
                <td className="px-3.5 py-2 whitespace-nowrap">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs font-semibold text-gray-900">{source.name}</span>
                  </div>
                </td>
                <td className="px-3.5 py-2 text-xs text-gray-500 whitespace-nowrap">{source.type}</td>
                <td className="px-3.5 py-2 whitespace-nowrap">
                  {source.status === 'Ready' ? (
                    ...
                    <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-yellow-50 text-yellow-600">
                      {STRINGS.TABLES.KNOWLEDGE.STATUS.PROCESSING}
                    </span>
                  )}
                </td>
                <td className="px-3.5 py-2 text-xs text-gray-500 whitespace-nowrap">{source.date}</td>
      ...
      <div className="px-4 py-2.5 border-t border-gray-100 bg-[#F9FAFB]/30 flex items-center gap-2.5">
        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-gray-200 text-gray-700 rounded-md text-xs font-semibold shadow-2xs hover:bg-gray-50 transition-colors">
