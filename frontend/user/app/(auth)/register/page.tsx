    ...
    <div className="w-full max-w-md space-y-6">
      ...
      <form className="space-y-5">
        <div className="space-y-1">
          <label className="text-sm font-semibold text-gray-900">{common.FULL_NAME_LABEL}</label>
          <input 
            type="text" 
        ...
        <div className="space-y-1">
          <label className="text-sm font-semibold text-gray-900">{common.CONFIRM_PASSWORD_LABEL}</label>
          <div className="relative">
            <input 
              type="password" 
        ...
        <div className="flex items-start gap-2 pt-2">
          <input type="checkbox" required className="w-4 h-4 mt-1 rounded border-gray-300 text-[#0066FF] focus:ring-[#0066FF]" />
        ...
        <button 
          type="submit" 
          className="w-full bg-[#0066FF] hover:bg-[#0052cc] text-white font-medium py-3 rounded-lg transition-colors shadow-sm mt-2"
        >
          {content.SUBMIT}
        </button>
      </form>
      ...
      <p className="text-center text-sm text-gray-600">
        {content.HAS_ACCOUNT} <Link href="/login" className="font-semibold text-[#0066FF] hover:underline">{content.SIGN_IN}</Link>
      </p>
    </div>
  );
}
