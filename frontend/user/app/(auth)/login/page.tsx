  ...
  return (
    <div className="w-full max-w-sm space-y-5">
      ...
      <form className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" className="w-3.5 h-3.5 rounded border-gray-300 text-[#0066FF] focus:ring-[#0066FF]" />
            <span className="text-xs text-gray-600">{content.REMEMBER_ME}</span>
          </label>
          <Link href="/forgot-password" className="text-xs font-medium text-[#0066FF] hover:underline">
      ...
      <div className="relative flex items-center py-1">
        ...
        <span className="flex-shrink-0 mx-3 text-gray-400 text-[11px] font-medium uppercase">{common.OR}</span>
        <div className="flex-grow border-t border-gray-200"></div>
      </div>

      <button 
        type="button" 
        className="w-full flex items-center justify-center gap-2 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-2 rounded-lg text-sm transition-colors shadow-sm"
      >
