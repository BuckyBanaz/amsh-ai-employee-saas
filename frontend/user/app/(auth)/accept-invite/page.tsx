  ...
  return (
    <div className="w-full max-w-md space-y-6">
      <div className="flex justify-center mb-6">
        <div className="w-12 h-12 bg-[#0066FF] rounded-xl flex items-center justify-center shadow-md">
      ...
      <form className="space-y-5">
        ...
        <button 
          type="submit" 
          className="w-full bg-[#0066FF] hover:bg-[#0052cc] text-white font-medium py-3 rounded-lg transition-colors shadow-sm mt-4"
        >
          {content.SUBMIT}
        </button>
      </form>
