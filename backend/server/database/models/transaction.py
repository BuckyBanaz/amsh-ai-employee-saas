...
class Transaction(Base):
    """Generic wrapper per the architecture — an appointment/order/reservation
    depending on vertical. Vertical-specific fields stay in `details` (JSON),
    validated by that vertical's config schema, so this table never needs new
    columns for a new vertical."""
