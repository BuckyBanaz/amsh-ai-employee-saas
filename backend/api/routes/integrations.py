...
No real provider OAuth/API calls yet (Twilio/Google keys aren't wired in) —
connect/disconnect just record intent so the onboarding flow and later the
Integrations settings screen have something real to read."""
...
from backend.database.models.integration import Integration
from backend.database.models.user import User
from backend.database.session import get_db

router = APIRouter(prefix="/api/businesses/{business_id}/integrations", tags=["integrations"])
