...
class KnowledgeDocument(Base):
    ...
    from the onboarding "Knowledge" step (frontend/user/app/onboarding/knowledge/page.tsx)
    via `doc_type`: an uploaded file, a synced website, or a manual FAQ — each
    uses a different subset of the optional fields below."""
